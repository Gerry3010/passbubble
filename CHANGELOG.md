...
- **Öffentliche Share-Links öffnen jetzt schon beim ersten Aufruf** (vorher: erst beim zweiten). Der Router wurde bei jeder Auth-Änderung neu erzeugt und verlor den Deep-Link — jetzt eine stabile Instanz mit `refreshListenable`
