...
- **„Sign in with …"-Merker in der Extension** — die Extension merkt sich gerätelokal pro Website, mit welchem SSO-Provider (Google/Apple/Microsoft/GitHub/Facebook) man sich dort anmeldet (Klick-Heuristik + Beobachtung der OAuth-Navigation, inkl. `window.open`-Popups), und zeigt beim nächsten Besuch einen Badge „You sign in here with Google →", der den Provider-Button der Seite anklickt. Vergessen per ×; nichts davon wird zum Server gesynct
